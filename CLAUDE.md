...
Desktop application for hierarchical management, preview, and export of PDF documents and receipts. Platform: Windows. UI: **React + Vite SPA inside a pywebview host** (Edge WebView2). Version: **3.7.3**.
...
| `version_info.py` | `APP_NAME`, `VERSION` (currently 3.7.3) |
...
- **Version `3.7.3`** (bug form default + BETA_TESTING heading) → bump when `version_info.py` changes.
