...
class TreeViewFrame(ttk.Frame):
    def __init__(self, master, controller):
        ...
        self.context_menu.add_command(label="Lesbarkeit geprüft",                 command=self._ctx_commit)
        self.context_menu.add_command(label="Kompression zurücksetzen",           command=self._ctx_reset_compression)
        self.context_menu.add_separator()
