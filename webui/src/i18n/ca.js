...
export const ca = {
  ...
  'In mehrere Dateien aufteilen': 'Divideix en diversos fitxers',
  'max. Seiten pro Datei': 'màx. pàgines per fitxer',
  'Trennen bei:': 'Talla a:',
  'oberste Ordner': 'carpetes de primer nivell',
  'jeder Ordnergrenze': 'qualsevol límit de carpeta',
  'mitten im Dokument': 'al mig del document',
  '{n} Dateien': '{n} fitxers',
}
