...
export const ko = {
  ...
  'In mehrere Dateien aufteilen': '여러 파일로 분할',
  'max. Seiten pro Datei': '파일당 최대 페이지',
  'Trennen bei:': '분할 기준:',
  'oberste Ordner': '최상위 폴더',
  'jeder Ordnergrenze': '모든 폴더 경계',
  'mitten im Dokument': '문서 중간(페이지 수 기준)',
  '{n} Dateien': '{n}개 파일',
}
